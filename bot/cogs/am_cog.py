...
am_descriptions = {
    ...
    """,
    "Academy push": """Construction template to build an academy in 8 days without PP commitment to quickly build nobles and then build out the village regularly.
